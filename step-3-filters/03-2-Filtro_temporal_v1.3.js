var param = { 
    regionGlacier: 1011,  //Region de Clasificacion
    pais: 'PERU', 
...
var ordem_exec_first =  [34];              //Filtro de primer año
var ordem_exec_last =   [25];                               //Filtro de ultimo año
var ordem_exec_middle = [25,34,25,34];  //Filtro de años intermedios
...
var Clasificacion_TD = ee.ImageCollection(dirinput)
                      ...
                      .filter(ee.Filter.eq('descripcion', 'gapfill'))
                      .mosaic()
